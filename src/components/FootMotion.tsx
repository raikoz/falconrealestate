            ...
            <section ref={containerRef} className={`relative h-[150vh] ${className}`}>
                <div className="sticky top-0 h-screen w-full overflow-hidden z-0 bg-black">
                    ...
                    <div className="absolute inset-0 z-0">
                        {!firstFrameLoaded && (
                            <img
                                src="/FootMotion/ezgif-frame-001.png"
                    ...
                    <div className="absolute inset-0 flex flex-col md:flex-row w-full h-full">
                        ...
                        >
                            <motion.span
                                ...
                                className="font-mono-tech text-xs md:text-sm tracking-[0.2em] text-white/80 mb-4"
                            >
                            ...
                            <motion.h1
                                ...
                                className="text-5xl md:text-6xl lg:text-8xl font-black text-white text-balance leading-[1.05]"
                            >
                                Precision in Every
                                <br />
                            ...
                            <motion.p
                                ...
                                className="text-white/90 mt-6 max-w-lg text-sm md:text-lg leading-relaxed font-light"
                            >
                            ...
                            >
                                <a href="/projects">
                                    <motion.button
                                        className="bg-white text-black px-8 py-4 font-mono-tech text-xs tracking-wider hover:bg-white/90 transition-colors duration-300 flex items-center gap-2"
                                        whileTap={{ scale: 0.96 }}
                                    >
                                        VIEW PROJECTS
                                        <svg
                                ...
                                <motion.button
                                    className="bg-primary/20 border border-primary text-white px-8 py-4 font-mono-tech text-xs tracking-wider hover:bg-primary hover:text-white transition-colors duration-300 backdrop-blur-sm"
                                    whileTap={{ scale: 0.96 }}
                                    onClick={() => {
                                        setIsFormOpen(true);
