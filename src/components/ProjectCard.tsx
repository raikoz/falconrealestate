...
const ProjectCard = ({ title, location, image, rera, status, slug, index }: ProjectCardProps) => {
  return (
    <motion.div
        ...
        >
          ...
          >
            ...
            <div className="absolute top-4 left-4">
              <span className={`font-mono-tech text-xs tracking-wider px-3 py-1.5 rounded-sm ${
                status === "ongoing"
